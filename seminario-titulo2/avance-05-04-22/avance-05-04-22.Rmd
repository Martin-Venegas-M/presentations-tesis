...
**Antecedentes:** Enfoque criminológico de las teorías del conflicto social y otros estudios
...
- **Medición:** Evaluaciones de Justicia -> comparaciones entre las recompensas reales (e.g. ingresos) y las recompensas consideradas justas (e.g. ingresos justos) de parte de un individuo.
  ...
  + No Reflexivas: quien recibe las recomensas y quien evalúa su justicia son diferentes (Observador ≠ Recompensado)
---

# Hipótesis 3

**Antecedentes:** Enfoque criminológico de las teorías del conflicto social (Thompson, 2004), justicia distributiva (normativa y empírica)
...
- ¿Categorizar Sentido de Injusticia para modelos?
---
class: slideInRight, middle, inverse
